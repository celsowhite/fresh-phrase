...
export const store = {
    ...
    setTranslation() {
        ...
        axios.get(`http://api.pearson.com/v2/dictionaries/${this.state.activeLanguageCode}/entries?offset=${searchOffset}&limit=30&apiKey=${apiConfig.pearson.apiKey}&apiSecret=GhdhSUFHOG5Ukm7Q${apiConfig.pearson.secretKey}`)
